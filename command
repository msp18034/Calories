...
# no concurrency
/opt/spark-2.4.3-bin-hadoop2.7/bin/spark-submit --master yarn --conf spark.scheduler.mode=FAIR  --conf spark.speculation=true  --conf spark.yarn.executor.memoryOverhead=1024 --executor-memory 5G  --conf spark.streaming.concurrentJobs=5 --total-executor-cores 30 --executor-cores 2 --num-executors 5 --py-files /home/hduser/backupcalorie/Calories/Kafka/classify.py,/home/hduser/backupcalorie/Calories/Kafka/yolov3.py,/home/hduser/backupcalorie/Calories/Kafka/volume.py --deploy-mode client --jars /opt/kafka_2.11-2.2.0/libs/spark-streaming-kafka-0-8-assembly_2.11-2.4.3.jar /home/hduser/backupcalorie/Calories/Kafka/backupdetect.py
